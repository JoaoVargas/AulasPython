...
def media_ponderada(prova, trabalho, exercicio):
    ...
    """
    media = (prova*7 + trabalho*2 + exercicio*1)/10
    print(media)
...
def converte_hora(horario):
    ...
    if  horas > 12:
        horas -= 12
        print("%02d" % (horas,) + ":" + "%02d" % (minutos,) + " pm")
    else:
        print(horario + " am")
    if  horas > 12:
        horas -= 12
        return("%02d" % (horas,) + ":" + "%02d" % (minutos,) + " pm")
    else:
        return(horario + " am")
...
def idade_canina(idade_humana, porte_do_cao):
    ...
    if porte_do_cao == "pequeno":
        idadeCanina = idade_humana // 5
    elif porte_do_cao == "medio":
        idadeCanina = idade_humana // 6
    else:
        idadeCanina = idade_humana // 7
    print(idadeCanina)
    return idadeCanina
...
def nota_para_conceito(nota):
    ...
    if 9 <= nota and nota <= 10:
        print("A")
    elif 8 <= nota and nota < 9:
        print("B")
    elif 7 <= nota and nota < 8:
        print("C")
...
def comprar_frutas(morango=0, uva=0):
    ...
    precoTotal = precoMorango + precoUva
    pesoTotal = morango + uva
